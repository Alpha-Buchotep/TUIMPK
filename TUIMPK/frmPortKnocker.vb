...
Public Class frmPortKnocker
    ...
    Private Sub frmPortKnocker_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If My.Settings.donotloadpwd <> Nothing Then

            If My.Settings.donotloadpwd = "1" Then
                cbDoNotShowPwd.Checked = True
                doNotShowPwd = 1
            ElseIf My.Settings.donotloadpwd = "0" Then
                cbDoNotShowPwd.Checked = False
                doNotShowPwd = 0
            End If
        ...
        If My.Settings.theme <> Nothing Then
            ...
            ElseIf My.Settings.theme = "tema1" Then
                Me.BackgroundImage = My.Resources.formBg_1
                alapTema = 3

            ElseIf My.Settings.theme = "tema2" Then
                Me.BackgroundImage = My.Resources.formBg_2
                alapTema = 4

            ElseIf My.Settings.theme = "tema3" Then
                Me.BackgroundImage = My.Resources.formBg_3
                alapTema = 5

            ElseIf My.Settings.theme = "tema4" Then
                Me.BackgroundImage = My.Resources.formBg_4
                alapTema = 6

            ElseIf My.Settings.theme = "tema5" Then
                Me.BackgroundImage = My.Resources.formBg_5
                alapTema = 7
            Else
                Me.BackgroundImage = My.Resources.frmBgDark
                alapTema = 1
        ...
        If My.Settings.cfgPwd <> Nothing Then
            ...
            Try
                ...
                pbPwdSet.Image = My.Resources.yes

                If doNotShowPwd = 0 Then
                    tbPwd.Text = crAusrEc
                Else
                    tbPwd.Text = ""
                End If
            ...
            Catch ex As Exception
                ...
                pbPwdSet.Image = My.Resources.no
            End Try
        ...
        Else
            ...
            If cfgSaveDialog.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Try
                    ...
                    If Len(cfgSaveDialog.FileName) > 50 Then

                        Dim pthLenSett As Integer = Len(cfgSaveDialog.FileName)
                        Dim startCharSett As Integer = pthLenSett - 50
                        Dim cfgPthSett As String = "..." & cfgSaveDialog.FileName.Substring(startCharSett, 50)

                        lblLoadedCfg.Text = "" & cfgPthSett

                    Else

                        lblLoadedCfg.Text = "" & cfgSaveDialog.FileName
    ...
    Private Sub cfgLoadDialog_FileOk(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cfgLoadDialog.FileOk
        ...
        Else
            ...
            If Len(cfgLoadDialog.FileName) > 50 Then

                Dim pthLenSett As Integer = Len(cfgLoadDialog.FileName)
                Dim startCharSett As Integer = pthLenSett - 50
                Dim cfgPthSett As String = "..." & cfgLoadDialog.FileName.Substring(startCharSett, 50)

                lblLoadedCfg.Text = "" & cfgPthSett

            Else

                lblLoadedCfg.Text = "" & cfgLoadDialog.FileName
    ...
    Private Sub BtnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        ...
        Dim resetResult As DialogResult = MessageBox.Show("Are You sure You want to reset all settings?" & vbCrLf & "This will clear saved passwords also.", "Reset to defaults?", MessageBoxButtons.YesNo, MessageBoxIcon.Question)

        If resetResult = DialogResult.Yes Then

            'Reset
            chkBoxDNS.CheckState = CheckState.Unchecked
            cbDoNotShowPwd.CheckState = CheckState.Unchecked
            tbHostIp.Clear()
            tbPortA.Clear()
            tbPortB.Clear()
            tbPortC.Clear()
            ...
            My.Settings.cfgPwd = Nothing
            My.Settings.delay = Nothing
            My.Settings.donotloadpwd = Nothing
            My.Settings.posX = Nothing
            My.Settings.posY = Nothing
            My.Settings.theme = Nothing
            My.Settings.Save()
            ...
            ttStatus.Text = "Standby - Reseted to defaults. Passwords cleared!"
            lblLoadedCfg.Text = "No config file loaded."
            pbPwdSet.Image = My.Resources.no
    ...
    '----------------------------------------------------------------------
    Private Sub gBoxSettings_MouseDown(sender As Object, e As MouseEventArgs) Handles gBoxSettings.MouseDown
        a = Control.MousePosition.X - Me.Location.X
        b = Control.MousePosition.Y - Me.Location.Y
        Me.Opacity = 0.7
    End Sub
    Private Sub gBoxSettings_MouseMove(sender As Object, e As MouseEventArgs) Handles gBoxSettings.MouseMove
        If e.Button = MouseButtons.Left Then
            newPoint = Control.MousePosition
            newPoint.X = newPoint.X - (a)
            newPoint.Y = newPoint.Y - (b)
        ...
        End If
    End Sub
    Private Sub gBoxSettings_MouseUp(sender As Object, e As MouseEventArgs) Handles gBoxSettings.MouseUp
        Me.Opacity = 1
    End Sub
    ...
    Private Sub LblIkon_DoubleClick(sender As Object, e As EventArgs) Handles lblIkon.DoubleClick
        ...
        ElseIf alapTema = 2 Then
            ...
            Me.BackgroundImage = My.Resources.formBg_1
            My.Settings.theme = "tema1"
            My.Settings.Save()
            alapTema = 3

        ElseIf alapTema = 3 Then

            Me.BackgroundImage = My.Resources.formBg_2
            My.Settings.theme = "tema2"
            My.Settings.Save()
            alapTema = 4

        ElseIf alapTema = 4 Then

            Me.BackgroundImage = My.Resources.formBg_3
            My.Settings.theme = "tema3"
            My.Settings.Save()
            alapTema = 5

        ElseIf alapTema = 5 Then

            Me.BackgroundImage = My.Resources.formBg_4
            My.Settings.theme = "tema4"
            My.Settings.Save()
            alapTema = 6

        ElseIf alapTema = 6 Then

            Me.BackgroundImage = My.Resources.formBg_5
            My.Settings.theme = "tema5"
            My.Settings.Save()
            alapTema = 7

        ElseIf alapTema = 7 Then
    ...
    Private Sub BtnPwdOkay_Click(sender As Object, e As EventArgs) Handles btnPwdOkay.Click
        ...
        If tbPwd.Text = "" And chkBoxPwdSave.CheckState = CheckState.Unchecked Then
            ...
            Dim pwdClearResult As DialogResult = MessageBox.Show("Are You sure You want to clear saved passwords?", "Clear saved passwords?", MessageBoxButtons.YesNo, MessageBoxIcon.Question)

            If pwdClearResult = DialogResult.Yes Then
                ...
                MessageBox.Show("Passwords cleared.", "Oops!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Exit Sub
    ...
    '----------------------------------------------------------------------
    Private Sub CbDoNotShowPwd_CheckedChanged(sender As Object, e As EventArgs) Handles cbDoNotShowPwd.CheckedChanged

        If cbDoNotShowPwd.Checked = True Then

            My.Settings.donotloadpwd = "1"
            doNotShowPwd = 1
            'tbPwd.Text = ""

        ElseIf cbDoNotShowPwd.Checked = False Then

            My.Settings.donotloadpwd = "0"
            doNotShowPwd = 0

            'If crAusrEc.Length > 8 Then
            'tbPwd.Text = crAusrEc
            'Else
            'tbPwd.Text = ""
            'End If
